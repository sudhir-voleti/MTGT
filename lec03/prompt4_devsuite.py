...
# Prompt 4 — Phase 5: Radar Chart + Ranking Highlights + DevSuite Overlay
...
def handle_compute(b):
    ...
    try:
        ...
        # Store DevSuite reference for radar
        devsuite_scores = {
...
display(widgets.HTML("<p><b>Upload → Configure → Weight → Compute, Rank & Visualize.</b></p>"))
display(tabs)
